...
function spntax_admin_styles_and_scripts()
{
    ...
    if (isset($_REQUEST['page']) && !empty($_REQUEST['page']) && (sanitize_text_field($_REQUEST['page']) == 'spintax' || sanitize_text_field($_REQUEST['page']) == 'spintax-import' || sanitize_text_field($_REQUEST['page']) == 'spintax-setting' ||  sanitize_text_field($_REQUEST['page']) == 'spintax-bulk-edit' )) {
